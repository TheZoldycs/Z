  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          verticalSpaceLarge,
          Text('Health Dashboard'.tr(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 20),),
          verticalSpaceMedium,
          Text("Track your progress, set goals, and stay informed about your fitness journey.".tr(), style: const TextStyle(color: kGrayText, fontWeight: FontWeight.w700,), textAlign: TextAlign.center),
