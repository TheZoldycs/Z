...
import 'package:z/ui/views/index/index_view.dart';
import 'package:z/ui/views/login/login_viewmodel.dart';
import 'package:z/ui/views/onboarding/onboarding_view.dart';
            ...
            child: Container(
              ...
              child: ListView(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.arrow_back_ios_new_outlined, ).center(),
                      ).gestures(
                  ...
                  verticalSpaceSmall,
                  Text("Login".tr(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 20)).center(),
                  ...
                  verticalSpaceSmall,
                  Text("You haven't an account? Sign Up".tr(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700),).center().gestures(
                    onTap: () => model.navigateTo(view: const OnBoardingView()),
                  ),
                  verticalSpaceMedium,
                ],
